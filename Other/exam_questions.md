...
### AXI-Lite
65. Почему AXI4-Lite является memory-mapped интерфейсом?
66. Чем AXI4-Lite похож на APB?
67. Почему AXI4-Lite удобно использовать в AXI-системах?
68. Чем AXI4-Lite похож на AXI-Stream?
69. Какие пять каналов есть в AXI4-Lite?
70. Какие каналы участвуют в операции записи?
71. Какие каналы участвуют в операции чтения?
72. Чем адрес в AXI4-Lite похож на `TDEST` в AXI-Stream?
73. Почему interconnect должен маршрутизировать не только запросы, но и ответы?
74. Где в AXI4-Lite crossbar возникает арбитраж?
75. Почему AXI4-Lite и AXI-Stream часто используются вместе?
76. Зачем может понадобиться AXI4-Lite -> APB bridge?
