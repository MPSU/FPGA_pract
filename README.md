...
1. [Лабораторная работа 1. Tcl](./Labs/01.%20Tcl/README.md) + [Лабораторная работа 2. LUT, FF, Carry](./Labs/02.%20LUT%20and%20FF/README.md) + [Лабораторная работа 3. DSP ячейки](./Labs/03.%20DSP/README.md)
2. [Лабораторная работа 4. LUTRAM, BRAM](./Labs/04.%20LUTRAM%20BRAM/README.md)
3. [Лабораторная работа 5. Конвейеры и систолические массивы](./Labs/05.%20Pipelines%20and%20Systolic%20arrays/README.md)
...
* Понижение 80% (например, максимум 2 балла из 10) - на занятии через месяц и две недели после проведения лабораторной и далее
